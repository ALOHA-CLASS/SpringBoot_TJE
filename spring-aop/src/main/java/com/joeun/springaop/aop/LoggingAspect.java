package com.joeun.springaop.aop;
...
public class LoggingAspect {
	 ...
	 * - 인수
	 */
	@Before("execution(* com.joeun.springaop.service.BoardService*.*(..))")
	...
	@After("execution(* com.joeun.springaop.service.BoardService*.*(..))")
	 ...
	 * - proceed() 			: 대상 메소드 호출
	 */
	@Around("execution(* com.joeun.springaop.service.BoardService*.*(..))")
	...
	@AfterReturning(pointcut = "execution(* com.joeun.springaop.service.BoardServiceImpl.*(..))", returning = "result")
	...
	@AfterThrowing(pointcut = "execution(* com.joeun.springaop.service.BoardService*.*(..))", throwing ="exception")
